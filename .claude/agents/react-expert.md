...
- Modern JavaScript best practices and ES6+ features
...
2. **Provide Actionable, Best-Practice Solutions**
   - Recommend specific components and their optimal configurations
...
6. **Provide Context and Education**
   ...
   - Reference official React documentation when applicable
...
- The web client is in `/web` and uses Vite for building
- Uses MUI v5 with Emotion for styling
...
- Verify the solution follows React best practices
