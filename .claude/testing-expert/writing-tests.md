...
This document provides practical, step-by-step guidance for writing tests for new features in the Postgres MCP Server project.
...
```bash
# If source file is: internal/database/connection.go
# Create test file:  internal/database/connection_test.go
```
...
**Package Integration**: Co-located (e.g., `internal/integration/`)
...
import (
    ...
    "pgedge-postgres-mcp/tests/testutil"
    "github.com/stretchr/testify/assert"
    "github.com/stretchr/testify/require"
)
```
...
// 1. Production code: internal/usermgmt/password.go
package usermgmt
...
// 2. Test code: internal/usermgmt/password_test.go
package usermgmt
