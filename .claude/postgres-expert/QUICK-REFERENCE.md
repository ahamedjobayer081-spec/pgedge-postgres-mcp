...
psql -h localhost -U pgedge_mcp -d pgedge_mcp
...
pg_dump -Fc -f pgedge_mcp_backup.dump pgedge_mcp

# Logical backup (specific tables)
pg_dump -Fc -t user_accounts -t connections -f core_tables.dump pgedge_mcp

# Plain SQL backup
pg_dump -f pgedge_mcp_backup.sql pgedge_mcp
```
...
pg_restore -d pgedge_mcp pgedge_mcp_backup.dump

# Restore specific table
pg_restore -d pgedge_mcp -t user_accounts pgedge_mcp_backup.dump

# Restore from SQL file
psql -d pgedge_mcp -f pgedge_mcp_backup.sql
```
...
---
**Location:** `/.claude/.claude/postgres-expert/`
