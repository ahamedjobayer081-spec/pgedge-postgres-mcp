...
This directory contains security-specific documentation for the pgEdge Postgres
MCP Server project.
...
|------|------------|--------|
| `/internal/auth/` | **Critical** | Authentication logic |
| `/internal/tools/` | **High** | SQL execution |
| `/internal/database/` | **High** | Database operations |
