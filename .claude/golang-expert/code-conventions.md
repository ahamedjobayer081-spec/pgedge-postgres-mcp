/*-----------------------------------------------------------
 *
 * pgEdge Postgres MCP Server - Go Code Conventions
 *
...
used in the pgEdge Postgres MCP Server project.
...
// Bad
logging.Info("Connection string", "connStr", connString)  // May contain password!
```
