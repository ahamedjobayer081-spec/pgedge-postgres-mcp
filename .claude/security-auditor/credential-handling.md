...
This document describes how credentials and secrets are managed in the pgEdge
Postgres MCP Server.
...
**Location:** `/internal/auth/` and `/internal/database/users.go`
...
**Location:** `/internal/auth/sessions.go`
...
**Location:** Database table `connections`, `/internal/database/`
