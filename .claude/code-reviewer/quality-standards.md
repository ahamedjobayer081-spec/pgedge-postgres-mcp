...
This document defines code quality standards for the pgEdge Postgres MCP
Server project.
...
| PropTypes | ComponentName.propTypes | `UserProfile.propTypes` |
...
// BAD
    ...
    console.log(error.message);  // error may not have message
}
...
- Unit tests: Co-located or in `/web/tests/`
