...
This directory contains comprehensive documentation for building the pgEdge
Postgres MCP Server React frontend application. The documentation is designed to provide
...
**Topics Covered**:
- Technology stack (React, JavaScript, MUI, Vite)
- Project structure and organization
- Architecture principles (separation of concerns, prop validation, security)
...
This documentation is maintained as part of the pgEdge Postgres MCP Server project.
