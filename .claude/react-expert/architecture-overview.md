...
for the pgEdge Postgres MCP Server React frontend client application.
...
- Define PropTypes for all component props
- Use defaultProps for default values
- Document prop shapes clearly
