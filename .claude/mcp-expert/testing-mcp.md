...
This document describes the testing strategy and best practices for the pgEdge Postgres MCP Server.
...
func TestIntegrationScenario(t *testing.T) {
    ...
    cfg.PgPort = 5432
    cfg.PgDatabase = "pgedge_mcp_test"
...
```bash
go test ./internal/mcp/... -run TestHandleInitialize
```
...
```bash
go test ./internal/mcp/... -run TestSpecificTest -v
```
