...
This directory contains comprehensive documentation about testing infrastructure, patterns, and best practices for the pgEdge Postgres MCP Server project.
...
- Package-level: `internal/<package>/integration/`
...
- Use `TEST_PGEDGE_MCP_KEEP_DB=1` to inspect test database
...
**Note**: This knowledge base is for the Testing Framework Architect agent and serves as a comprehensive reference for all testing-related guidance in the Postgres MCP Server project.
